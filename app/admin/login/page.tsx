      ...
      <main className="relative z-10 w-full max-w-md px-4">
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl shadow-2xl p-8 md:p-10 relative overflow-hidden group">
          ...
          <div className="text-center mb-8 space-y-2">
            <div className="relative inline-flex items-center justify-center w-24 h-24 rounded-full shadow-2xl shadow-black/50 mb-6 ring-4 ring-coffee-gold/20 overflow-hidden fade-in">
               <Image 
                  src="/logo/logo.jpg" 
                  alt="Admin Logo" 
                  fill 
